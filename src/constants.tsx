export const GENERAL_INFO_DESC =
  "With multiple years of experience as a web developer, I am eager to explore work opportunities that will help me grow and provide value to clients.";
export const SKILLS_DESC =
  "Programming Languages: Javascript/Typescript, Java Frameworks: AWS CDK Frontend: ReactJS, AngularJS Backend: AWS, " +
  "Google Firebase AWS Services: DynamoDB, RDS, Lambda, Cloudwatch, Code Pipeline, Systems Manager, API Gateway, S3, " +
  " Cloudfront Firebase Services: Firestore, Cloud Functions";
export const WORK_EXPERIENCE_DESC =
